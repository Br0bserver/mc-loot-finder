...
`mc-loot-finder` 是一个用于 Minecraft Java 26.1.2 的命令行工具。当前独立版可以根据世界种子精确定位远古城市、堡垒遗迹、沙漠神殿、掠夺者前哨站、埋藏的宝藏、沉船、末地城和林地府邸，列出其中的容器，并搜索指定战利品。
...
- 精确支持 Minecraft Java 26.1.2 的远古城市、堡垒遗迹、沙漠神殿、掠夺者前哨站、埋藏的宝藏、沉船、末地城和林地府邸的定位、结构布局、方块容器和战利品。
